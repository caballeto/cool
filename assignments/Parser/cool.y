...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> optional_expr_list expr_list expr_block
    %type <expression> expr let init
    ...
    */
    ...
    feature
    : OBJECTID ':' TYPEID init ';' { $$ = attr($1, $3, $4); }
    ...
    expr_block
    : expr ';' { $$ = single_Expressions($1); }
    | expr_block expr ';' { $$ = append_Expressions($1, single_Expressions($2)); }
    | error ';' { yyerrok; }
    ; 
    ...
    let
    : OBJECTID ':' TYPEID init IN expr %prec PRECEDE { $$ = let($1, $3, $4, $6); }
    | OBJECTID ':' TYPEID init ',' let { $$ = let($1, $3, $4, $6); }
    | error ',' let { yyerrok; }
    ;

    expr
    : OBJECTID ASSIGN expr { $$ = assign($1, $3); }
    | expr '.' OBJECTID '(' optional_expr_list ')' { $$ = dispatch($1, $3, $5); }
    | expr '@' TYPEID '.' OBJECTID '(' optional_expr_list ')' { $$ = static_dispatch($1, $3, $5, $7); }
    | OBJECTID '(' optional_expr_list ')' { $$ = dispatch(object(idtable.add_string("self")), $1, $3); }
